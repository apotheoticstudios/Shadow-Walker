...
public final class ShadowWalkerConfig {
    ...
    public static final ForgeConfigSpec.BooleanValue ALLOW_SNEAKING_OVER_BLOCK_EDGES;
    ...
    static {
        ...
        ALLOW_SNEAKING_OVER_BLOCK_EDGES = builder.comment("Allow players to move over block edges while sneaking instead of being stopped by vanilla edge protection.")
                .define("allowSneakingOverBlockEdges", true);
        ...
        CROSSHAIR_DETECTION_RANGE = builder.comment("Maximum range at which partial awareness can change the stealth crosshair. Fully detected mobs use fixed 20/40 block display bands.")
        ...
        DETECTION_EXCLAMATION_MARK_SCALE = builder.comment("World-space scale for the red exclamation mark above detected mobs. Smaller values make it smaller.")
                .defineInRange("detectionExclamationMarkScale", 0.03D, 0.004D, 0.05D);
